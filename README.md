...
status: "A aguardar correções da entidade"   #Entre as aspas escreve o estado do relatório
---
...
<details>
  ...
  <ul aria-label="lista de relatórios já efetuados">
    <li><a href="ddmmaaaa_report.html">(28/04/2026). Relatório {{ page.website }}</a></li>
  </ul>
</details>
